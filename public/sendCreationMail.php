...
try {
    ...
    while ($datas = $req->fetch()) {
        ...
        $url = "http://localhost/Mailtrap/public/index.php?action=edit_annonce&id=$emailId";
        //Contenus du mail
        $mail->Body = '
    <!DOCTYPE html>
    <html>
    ...
    <div style="padding: 20px;">
        ...
        <a href="' . $url . '" style="background-color: #407D9B; color: #F0F1F2; padding: 20px; text-decoration: none;">Valider votre annonce</a><br />
        <br />
